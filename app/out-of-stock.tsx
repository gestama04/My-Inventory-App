    ...
    useCallback(() => {
      const loadItems = async () => {
        ...
        try {
          ...
          // Filtrar itens sem stock (quantidade = 0)
          ...
          const sortedItems = sortItems([...outOfStockItems], sortType);
          ...
          console.error("Erro ao carregar itens sem stock", error);
        } finally {
          setLoading(false);
        }
      };
          ...
          >
            ...
            <Text style={[styles.sortButtonText, currentTheme === "dark" ? styles.darkText : styles.lightText]}>
              {sortType === 'nameAsc' ? 'Nome A-Z' :
               ...
               sortType === 'categoryAsc' ? 'Cat. A-Z' :
               sortType === 'categoryDesc' ? 'Cat. Z-A' :
                ...
                <View style={[
                  ...
                  <View style={styles.itemCardContent}>
                    ...
                    <View style={styles.quantityContainer}>
                      <Text style={[styles.quantityText, {color: "#e74c3c"}]}>
                        {item.quantity}
                      </Text>
